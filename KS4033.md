...
**4. Test Code**
This code does not work.  It is for the other motor driver board with the TB6612FNG  motor driver chip.  With the DRV8833CPWP, the pin 14 high is not necessary.  Plus the commands for pin 1 and pin 2 should be removed.  Third, some of the digial writes for pins 12,13, 15 and 16 should be analog write, depending on direction.  I wasted hours figuring this out.  Shame on Keyestudio for providing incorrect example code.
